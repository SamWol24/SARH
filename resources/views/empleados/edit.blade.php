                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('empleados.update', $empleado->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('posicion') is-invalid @enderror" id="posicion" name="posicion" value="{{ old('posicion', $empleado->posicion) }}" required>
                                @error('posicion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('fecha_contratacion') is-invalid @enderror" id="fecha_contratacion" name="fecha_contratacion" value="{{ old('fecha_contratacion', $empleado->fecha_contratacion) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('salario') is-invalid @enderror" id="salario" name="salario" value="{{ old('salario', $empleado->salario) }}" required>
                                @error('salario')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
